...
def main():
    ...
    with open('scrap.csv', 'w', newline='') as f:
        ...
        writer.writerow(['Name', 'Motor', 'Year release', 'Kms', 'Box', 'Energy', 'Price'])
...
def scrap_motor(soup):
    # Scrape the motor of the car
    return forming(soup.find_all('h3', {'class': 'VehicleCard_VehicleCard__Title1'}))
